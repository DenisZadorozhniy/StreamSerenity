...
public class ActionPage extends PageObject {
    ...
    @FindBy(xpath = "//div[contains(@id,'tab_select_TopSellers')]")
    private WebElement topSellersBtn;
    @FindBy(xpath = "//div[contains(@id,'TopSellersTable')]//div[contains(@class,'discount_pct')]//..//..//div[contains(@class,'tab_item_name')]")
    private List<WebElement>titleGames;
    @FindBy(xpath = "//div[contains(@id,'TopSellersTable')]//div[contains(@class,'discount_pct')]")
    private List<WebElement>discountGames;
    @FindBy(xpath = "//div[contains(@id,'TopSellersTable')]//div[contains(@class,'discount_pct')]//..//..//div[contains(@class,'discount_final_price')]")
